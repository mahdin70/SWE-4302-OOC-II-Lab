...
class ShamelessGreenTest {
    ...
    void verse2() {
        ...
        ShamelessGreen shamelessGreen = new ShamelessGreen();
        assertEquals(expected, shamelessGreen.verse(2));
    }


    @Test
    void verse66() {
        String expected ="66"+" bottles of beer on the wall, "+"66"+" bottles of beer.\n" +
                "Take one down and pass it around, "+"65"+" bottles of beer on the wall.\n";
        ShamelessGreen shamelessGreen = new ShamelessGreen();
        assertEquals(expected, shamelessGreen.verse(66));
    }
    @Test
    void verseRange() {
        String expected ="69 bottles of beer on the wall, 69 bottles of beer.\n" +
                ...
                "Take one down and pass it around, 65 bottles of beer on the wall.\n";
        ShamelessGreen shamelessGreen = new ShamelessGreen();
        assertEquals(expected, shamelessGreen.verse(69,66));
    }
    @Test
    void song() {
        String expected="99 bottles of beer on the wall, 99 bottles of beer.\n" +
                ...
                "Go to the store and buy some more, 99 bottles of beer on the wall.\n";
        ShamelessGreen shamelessGreen = new ShamelessGreen();
        assertEquals(expected, shamelessGreen.verse(99,0));
    }
}
